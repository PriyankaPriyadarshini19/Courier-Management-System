...
const steps = [
  { num: '01', title: 'Create Shipment', desc: 'Book your parcel online or at any SwiftInd branch.' },
...
const testimonials = [
  { name: 'Satyajit Monahty', city: 'Bhubaneswar', text: 'SwiftInd delivered my package from Bhubaneswar to Delhi in just one day. Incredible speed!', rating: 5 },
  { name: 'Priyanka Behera', city: 'Nashik', text: 'Very reliable and the tracking updates are always accurate. Highly recommended.', rating: 5 },
  { name: 'Pratik Rout', city: 'Mumbai', text: 'Best rates in the market and their customer support is outstanding.', rating: 4 },
];
  ...
  return (
    <div className="overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="mt-6 text-lg text-muted-foreground max-w-lg leading-relaxed">
                From India to Dubai, SwiftInd delivers your parcels safely and on time. Same-day, overnight, and standard delivery options available.
              </p>
            ...
            >
              <div className="relative w-80 h-80">
                ...
                <div className="absolute bottom-6 left-4 flex flex-col items-center">
                  ...
                  <span className="text-xs font-medium text-primary mt-1">Delhi</span>
                </div>
                {/* Destination pin */}
                <div className="absolute bottom-6 right-4 flex flex-col items-center">
                  <MapPin className="h-8 w-8 text-accent" />
                  <span className="text-xs font-medium text-accent mt-1">Cuttack</span>
                </div>
                {/* Moving parcel */}
                <motion.div
                  className="absolute"
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div {...fadeUp} className="text-center mb-14">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground">Why Choose SwiftInd?</h2>
          </motion.div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => (
              <motion.div
