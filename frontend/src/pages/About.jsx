...
const values = [
  { icon: Zap, title: 'Speed', desc: 'Lightning-fast deliveries across India with optimized routes.' },
  ...
  <div className="min-h-screen pt-24 pb-20">
    <div className="container mx-auto px-4 md:px-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
        <h1 className="font-display text-3xl md:text-5xl font-bold text-foreground">About SwiftInd</h1>
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          Revolutionizing parcel delivery across India with speed, reliability, and cutting-edge technology.
        </p>
      </motion.div>
      ...
      <motion.section {...fadeUp} className="max-w-3xl mx-auto mb-20">
        ...
        <p className="text-muted-foreground leading-relaxed mb-4">
          Founded in 2022, SwiftInd emerged from a simple idea: India deserves a courier service that matches global standards. Starting with just 5 riders in Delhi, we've grown into a nationwide network covering 200+ cities.
        </p>
          ...
          <Card className="h-full border-border/50 shadow-sm">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                To provide fast, affordable, and reliable delivery services that connect every corner of India, empowering businesses and individuals alike.
              </p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div {...fadeUp} transition={{ delay: 0.1 }}>
          <Card className="h-full border-border/50 shadow-sm">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground">
                To build India's most modern logistics network — one that leverages technology to deliver parcels faster, smarter, and with complete transparency.
              </p>
            </CardContent>
          </Card>
        </motion.div>
