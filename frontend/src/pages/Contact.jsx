...
const contactInfo = [
  { icon: MapPin, label: 'Address', value: '123 Logistics Hub, Main Boulevard, Delhi, India' },
  { icon: Phone, label: 'Phone', value: '+92 300 1234567' },
  { icon: Mail, label: 'Email', value: 'info@swiftind.ind' },
];
            ...
            <Card className="border-border/50 shadow-sm">
              <CardContent className="p-6 md:p-8">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label>Phone</Label>
                    <Input placeholder="+91 XXX XXXXXXX" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} />
                  </div>
                  <div className="space-y-2">
                    <Label>Message *</Label>
