  ...
  <footer className="bg-foreground text-primary-foreground">
    <div className="container mx-auto px-4 md:px-6 py-16">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-xl font-bold">
              Swift<span className="text-accent">Ind</span>
            </span>
          </div>
          <p className="text-sm opacity-70 leading-relaxed">
            India's trusted courier & parcel delivery service. Fast, reliable, and affordable shipping solutions nationwide.
          </p>
        </div>
      ...
      <div className="mt-12 pt-8 border-t border-primary-foreground/10 text-center text-sm opacity-50">
        © {new Date().getFullYear()} SwiftInd. All rights reserved.
      </div>
    </div>
  </footer>
);
